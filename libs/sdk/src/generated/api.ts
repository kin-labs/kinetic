...
export const TransactionApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiTransactionFeatureControllerSubmitTransaction(options?: any): AxiosPromise<void> {
      return localVarFp
        .apiTransactionFeatureControllerSubmitTransaction(options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class TransactionApi extends BaseAPI {
   ...
   * @memberof TransactionApi
   */
  public apiTransactionFeatureControllerSubmitTransaction(options?: AxiosRequestConfig) {
    return TransactionApiFp(this.configuration)
      .apiTransactionFeatureControllerSubmitTransaction(options)
      .then((request) => request(this.axios, this.basePath))
  }
